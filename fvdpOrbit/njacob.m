function JJ=njacob(xx,nb,lam,pars)

%
% Usage: JJ=njacob(xx,nb,lam,pars)
%
...
for ii=1:N
	...
	for jj=1:cdm
		...
		JJ((im-1)*cdm+1:im*cdm, (ii-1)*cdm+jj)= ...
			(lcfunc(xx([im,ii],:),nb([im,ii],:),lam,pars)- ...
			fd((im-1)*cdm+1:im*cdm))/jig;

		JJ((ii-1)*cdm+1:ii*cdm, (ii-1)*cdm+jj)= ...
			(lcfunc(xx([ii,ip],:),nb([ii,ip],:),lam,pars)- ...
